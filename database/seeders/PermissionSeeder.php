...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            "partner_index" => "Partnerek listázása",
            "partner_create" => "Partnerek létrehozása",
            "partner_edit" => "Partnerek szerkesztése",
            "partner_delete" => "Partnerek törlése",
            "supporter_index" => "Támogatók listázása",
            "supporter_create" => "Támogatók létrehozása",
            "supporter_edit" => "Támogatók szerkesztése",
            "supporter_delete" => "Támogatók törlése",
            ...
            "any_news_archive" => "Bármely hírek archiválása, újraaktiválása",
            "any_news_approval" => "Bármely hírek jóváhagyása",
            "any_news_delete" => "Bármely hírek törlése",
            "any_foreign_news_index" => "Bármely külföldi hírek listázása",
            "any_foreign_news_create" => "Bármely külföldi hírek létrehozása",
            "any_foreign_news_edit" => "Bármely külföldi hírek szerkesztése",
            "any_foreign_news_archive" => "Bármely külföldi hírek archiválása, újraaktiválása",
            "any_foreign_news_approval" => "Bármely külföldi hírek jóváhagyása",
            "any_foreign_news_delete" => "Bármely külföldi hírek törlése",
            ...
            "any_events_archive" => "Bármely események archiválása, újraaktiválása",
            ...
            "any_pages_archive" => "Bármely oldalak archiválása, újraaktiválása",
